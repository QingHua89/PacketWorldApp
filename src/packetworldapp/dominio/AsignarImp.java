...
public class AsignarImp {
    public static HashMap<String,Object> obtenerTodas(){
        HashMap<String, Object> respuesta = new LinkedHashMap<>();
        String URL = Constantes.URL_WS + "asignacion/todas";
        RespuestaHTTP respuestaAPI = ConexionAPI.peticionGET(URL);
        if(respuestaAPI.getCodigo() == HttpURLConnection.HTTP_OK){
            Gson gson = new Gson();
            Type tipoLista = new TypeToken<List<AsignarUnidad>>(){}.getType();
            List<AsignarUnidad> asignaciones =
                gson.fromJson(respuestaAPI.getContenido(), tipoLista);
            respuesta.put("error", false);
            respuesta.put("asignacion", asignaciones);
        }else{
    ...
    public static Respuesta asignarUnidad(AsignarUnidad asignacion){
        Respuesta respuesta = new Respuesta();
        String URL = Constantes.URL_WS + "asignacion/asignar";
        Gson gson = new Gson();
    ...
    public static Respuesta retirarUnidad(AsignarUnidad asignacion) {
        Respuesta respuesta = new Respuesta();
        String URL = Constantes.URL_WS + "asignacion/retirar";
        Gson gson = new Gson();
        String parametrosJSON = gson.toJson(asignacion);
